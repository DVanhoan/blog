                    ...
                    <div className="mainheading">
                        ...
                        <div className="row post-top-meta">
                            ...
                            <div className="col-md-10">
                                ...
                                <span className="author-description">Founder of WowThemes.net and creator of <b>"Mediumish"</b>
                        ...
                        <div className="col-md-4">
                            <div className="card">
                                ...
                                <div className="card-block">
                                    <h2 className="card-title"><a href="post.html">Best recreational places to visit on a
                                        holiday</a></h2>
